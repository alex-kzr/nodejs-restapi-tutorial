...
httpServer.listen(config.httpPort, function(){
    console.log("The server is listening on http port "+config.httpPort+" in "+config.envName+" mode");
});
...
httpsServer.listen(config.httpsPort, function(){
    console.log("The server is listening on https port "+config.httpsPort+" in "+config.envName+" mode");
});
